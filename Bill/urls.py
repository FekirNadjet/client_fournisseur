...
urlpatterns = [
    ...
    re_path(r'^facture_ligne_create/(?P<facture_pk>\d+)/$', views.LigneFactureCreateView.as_view(),
            name='facture_ligne_create'),
    re_path(r'^facture_list/$', views.FacturesView.as_view(),
            name='facture_list'),
